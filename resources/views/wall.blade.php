    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="mx-auto mt-3 grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 border-t border-gray-200 pt-10 sm:mt-5 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            @foreach($posts as $post)
                <article class="flex max-w-xl flex-col items-start justify-start p-5" style="box-shadow:
                0 0 2px 1px #4d4d4d,
                0 0 3px 2px #666666,
                0 0 4px 3px #7b7b7b,
                0 0 5px 4px #999999,
                inset 0 0 8px 0 {{$post->category->color}};">
                    ...
                    <div class="relative mt-3 flex items-center gap-x-4">
                        ...
                        <img src="{{ asset('storage/' . $post->images->random()->path) }}" alt="">
                        @else
                        <img src="{{ asset("images/logo/default-banner.jpg") }}" alt="">
                        @endif
                    </div>
                </article>
            @endforeach
